...
# data: 2020 11 18
# script: popular as medias geometricas
...
# ===============================================================================
import moduloDecimaEntrega as mqe
#import schedule
#import time
import pymysql
import numpy as np
...
sql = 'INSERT INTO equipe2_analise(equipe_id, acao_id, soma, quantidade, minimo, maximo,desvio_padra,media,mediana,moda,amplitude,variacao,media_harmonica,media_geometrica)  values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s) ' % (id_equipe, acao_id, soma, quantidade, minimo, maximo, desvio_padrao, media, mediana, moda, amplitude, variancia, media_geo, media_harm)
